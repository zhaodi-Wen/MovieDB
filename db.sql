...
CREATE TABLE `Attend` (
  ...
  CONSTRAINT `fk_Customer_has_Showing_Customer` FOREIGN KEY (`Customer_idCustomer`) REFERENCES `Customer` (`idCustomer`) ON DELETE cascade ON UPDATE cascade ,
  CONSTRAINT `fk_Customer_has_Showing_Showing1` FOREIGN KEY (`Showing_idShowing`) REFERENCES `Showing` (`idShowing`) ON DELETE cascade ON UPDATE cascade
...
CREATE TABLE `Genre` (
  ...
  CONSTRAINT `fk_Genre_Movie1` FOREIGN KEY (`Movie_idMovie`) REFERENCES `Movie` (`idMovie`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Movie` (
  ...
  `Movie_Director` varchar(64),
  `Movie_Actor`  varchar(64),
  `Movie_Type`  varchar(41),
  `Movie_Country` varchar(41),
...
CREATE TABLE `Showing` (
  ...
  CONSTRAINT `fk_Showing_Movie1` FOREIGN KEY (`Movie_idMovie`) REFERENCES `Movie` (`idMovie`) ON DELETE CASCADE ON UPDATE CASCADE ,
  CONSTRAINT `fk_Showing_TheatreRoom1` FOREIGN KEY (`TheatreRoom_RoomNumber`) REFERENCES `TheatreRoom` (`RoomNumber`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- INSERT INTO `Showing` VALUES (1,'2016-02-11 21:30:00',1,1,5),(2,'2016-02-11 19:30:00',1,2,5),(9,'2016-02-11 19:00:00',2,3,2),(10,'2016-03-12 19:00:00',3,1,8),(11,'2016-03-12 21:00:00',4,1,8),(12,'2016-03-13 19:00:00',4,2,8),(13,'2016-03-20 19:00:00',4,1,4),(14,'2016-03-20 21:00:00',5,1,6),(15,'2016-03-22 20:30:00',8,2,4),(16,'2016-03-22 21:00:00',9,3,6),(17,'2016-03-20 19:00:00',10,2,8),(18,'2016-03-21 19:00:00',11,1,5),(19,'2016-03-23 22:00:00',11,1,3),(20,'2016-02-11 21:00:00',12,2,1);
